 ...
 */
class Version20180906172300 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE spending (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, provider_id INT DEFAULT NULL, date DATE NOT NULL, description VARCHAR(255) DEFAULT NULL, base_amount DOUBLE PRECISION NOT NULL, is_payed TINYINT(1) DEFAULT NULL, payment_date DATE DEFAULT NULL, payment_method INT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, removed_at DATETIME DEFAULT NULL, enabled TINYINT(1) NOT NULL, INDEX IDX_E44ECDD12469DE2 (category_id), INDEX IDX_E44ECDDA53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
